...
class getAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Security\\Authenticator'] = new \App\Security\Authenticator(($container->services['router'] ?? $container->getRouterService()), $container, ($container->services['.container.private.serializer'] ?? $container->load('get_Container_Private_SerializerService')));
    }
}
